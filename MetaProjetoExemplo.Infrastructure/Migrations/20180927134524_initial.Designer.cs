...
namespace MetaProjetoExemplo.Infrastructure.Migrations
{
    ...
    [Migration("20180927134524_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MetaProjetoExemplo.Domain.Common.ActionLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("MetaProjetoExemplo.Domain.Common.ActionLogType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("MetaProjetoExemplo.Domain.Common.ActionLog", b =>
                {
                    b.HasOne("MetaProjetoExemplo.Domain.Common.ActionLogType")
                        .WithMany()
